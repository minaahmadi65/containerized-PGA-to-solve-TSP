...
const MASTER_ENDPOINT = process.env.MASTER_ENDPOINT;
...
async function getJob() {
    try {
        //console.log('Master Endpoint:'+MASTER_ENDPOINT);
        const response = await axios.get(MASTER_ENDPOINT+'/get-job');
...
async function sendJobResult(result) {
    try {
        //console.log('Master Endpoint:'+MASTER_ENDPOINT);
        await axios.post(MASTER_ENDPOINT+'/post-result', result);
...
async function getSettings() {
    while (true) {  
        try {
            //console.log('Master Endpoint:'+MASTER_ENDPOINT);
            const response = await axios.get(MASTER_ENDPOINT+'/get-settings');
